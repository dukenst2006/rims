...
use Rims\App\Traits\Eloquent\Auth\HasConfirmationToken;
use Rims\App\Traits\Eloquent\Auth\HasTwoFactorAuthentication;
use Rims\App\Traits\Eloquent\Roles\HasPermissions;
...
class User extends Authenticatable
{
    ...
    /**
     * Get all of the user's languages.
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany
     */
    ...
    {
        return $this->morphMany(Portfolio::class, 'fileable');
    }
}
