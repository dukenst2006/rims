...
namespace Rims\Http\Account\Controllers\Subscription;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Mail;
use Rims\App\Controllers\Controller;
use Rims\Domain\Account\Requests\SubscriptionTeamMemberStoreRequest;
use Rims\Domain\Teams\Mail\TeamMemberAdded;
use Rims\Domain\Teams\Mail\TeamMemberDeleted;
